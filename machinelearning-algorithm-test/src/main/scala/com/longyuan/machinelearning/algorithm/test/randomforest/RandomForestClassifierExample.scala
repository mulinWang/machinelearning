...
/**
  ...
  */
class RandomForestClassifierExample extends FunSuite {
 System.setProperty("hadoop.home.dir", "D:\\hadoop-2.6.5")

 lazy val spark = SparkSession.builder.master("local[*]").appName("RandomForestClassifierExample").getOrCreate()
